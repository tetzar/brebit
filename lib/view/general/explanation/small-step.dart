          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                    "「スモールステップ」とは、ある行動を習慣にしていくためにはそのためのステップを小刻みにすべきという考え方です。"
              ...
              Container(
                child: Text(
                    "Brebitでは短期目標をクリアしていくことをスモールステップとしています。短期目標では連続して達成できた日数をカウントします。最初のステップ1は1日、最後のステップ8は20日です。",
                    style: Theme.of(context).textTheme.bodyText1),
              ),
              SizedBox(
                height: 8,
              ...
              Container(
                child: Text(
                    "ステップの途中で辞めたい習慣を実行してしまうと、カウントは0日に戻りますがステップは戻りません。\n目先の失敗ではなく過去の積み上げを意識して習慣改善に取り組んでみましょう。",
                    style: Theme.of(context).textTheme.bodyText1),
              ),
            ],
          ),
